...
void Cell::setSide(bool s) { side = static_cast<int>(s); }

bool Cell::getSide() const { return static_cast<bool>(side); }

int Cell::getGain() const { return gain; }

void Cell::setGain(int g) { gain = g; }

void Cell::incGain() { ++gain; }

void Cell::decGain() { --gain; }
