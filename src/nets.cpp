...
unsigned Net::trueCount() const { return on_true_side; }

unsigned Net::falseCount() const { return cells.size() - on_true_side; }
...
void Net::decCountOn(bool side) { incCountOn(!side); }
